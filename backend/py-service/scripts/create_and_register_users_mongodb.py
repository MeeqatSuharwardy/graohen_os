#!/usr/bin/env python3
"""Create MongoDB Users Collection and Register Test Accounts

This script:
1. Sets up the users collection with indexes
...
from setup_mongodb_users import setup_users_collection
...
async def setup_collection():
    """Setup users collection with indexes"""
    try:
...
def main():
    """Main execution"""
    print("=" * 70)
    print("  Create MongoDB Users Collection and Register Test Accounts")
    print("=" * 70)
    print()
    ...
    if not success:
        print("\n❌ Failed to setup collection. Cannot proceed with registration.")
        sys.exit(1)
